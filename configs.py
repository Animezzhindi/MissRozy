...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 22617435))
	API_HASH = os.environ.get("API_HASH", "22617435")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","8009543249:AAHc9LuTwwat2ci6zOGqMzfWGuyMPC8T61g")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "Animezz_Hindi_Files_Bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1002394576542))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "7758734586"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://raunak930005:<db_password>@animezz.cstvx.mongodb.net/?retryWrites=true&w=majority&appName=Animezz")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002184209776")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002394576542")
